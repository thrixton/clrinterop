...
public class TlbImpCode
{
    ...
    {
        [PreserveSig]
        int ResolveTypeLib(string simpleName, Guid tlbId, int lcid, ushort majorVersion, ushort minorVersion, TypeLibTypes.Interop.SYSKIND syskind, out string bstrName);
    }
    ...
    public Assembly ResolveRef(Object TypeLib)
    {
        ...
        try
        {
            rslt = TlbImpCode.DoImport((System.Runtime.InteropServices.ComTypes.ITypeLib)TypeLib, 
                                    ...
                                    TlbImpCode.s_Options.m_ruleSetFileName);
