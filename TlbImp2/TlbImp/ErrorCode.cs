...
namespace tlbimp2
{
    ...
    public enum WarningCode : int
    {
        ...
        Wrn_BadVTable = 3023,
        Wrn_RuleMultipleMatch = 3024,
        Wrn_UnknownRuleActionParameter = 3025,
        Wrn_ConvertReturnValueToNoneOut = 3026,
        Wrn_AddCustomAttributeFailed = 3027,
        Wrn_CannotLoadResolveToType = 3028,
        Wrn_LoadRuleFileFailed = 3029,
    }
